...
$host = !empty(getenv('MOODLE_DOCKER_WEB_HOST')) ? getenv('MOODLE_DOCKER_WEB_HOST') : 'localhost';
...
$CFG->dataroot  = getenv('MOODLE_DOCKER_DATAROOT');
$CFG->admin     = 'admin';
...
$CFG->phpunit_dataroot  = getenv('MOODLE_DOCKER_PHPUNIT_DATAROOT');
$CFG->phpunit_prefix = 't_';
define('TEST_EXTERNAL_FILES_HTTP_URL', getenv('MOODLE_DOCKER_EXTTEST'));

$CFG->behat_wwwroot   = getenv('MOODLE_DOCKER_BEHAT_WEBROOT');
$CFG->behat_dataroot  = getenv('MOODLE_DOCKER_BEHAT_DATAROOT');
$CFG->behat_prefix = 'b_';
