...
\Moodle\Logger::create()->debug("Use of config.html files in authentication plugins have been deprecated. " .
...
function print_auth_lock_options($auth, $user_fields, $helptext, $retrieveopts, $updateopts, $customfields = array()) {
    global $DB, $OUTPUT;
    \Moodle\Logger::create()->debug("The function 'print_auth_lock_options' has been deprecated, " .
